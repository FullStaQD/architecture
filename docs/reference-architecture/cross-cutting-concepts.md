...
[building blocks](./building-block-view.md) across the stack.
...
## Fault Tolerance
Noise is deemed one of the most severe limitations of today's quantum computing
...
1. **Firmware-bundled:**
   ...
   [Physical Layer](./building-block-view.md#_white_box_phys_layer)).
...
2. **Compilation:**
   ...
   [System Layer](./building-block-view.md#_white_box_sys_layer)'s Compiler.
...
3. **Application-specific:**
   ...
   (see [Application Layer](./building-block-view.md#_white_box_app_layer)).
...
[Application Layer](./building-block-view.md#_white_box_app_layer) or the
